// "nameSpace" apelido carinhoso para um grande comando
// "const Engine" "Matter.Engine" criar um mecanismo de física
// "Matter.World" criar mundos
// "Matter.Bodies" criar corpos
// "Matter.Body" contem metodos ou funções para manipular corpos
// "const" é a simplificação de algum comando grande
const Engine = Matter.Engine;
const World= Matter.World;
const Bodies = Matter.Bodies;

// "var" declarar uma variavel
var engine, world;
...
function setup(){
   ...
   // colocar as caracteristicas/leis da física 
...
function draw(){
  ...
  //"body" contém metodos em funções para manipular corpos
